...
Requires python BioPython (`pip install biopython`). It should work with recent versions of Python 2 or 3.
...
if __name__ == "__main__":
    ...
    if args.pdbfile:
        ...
        pdbfile = os.path.splitext(ciffile)[0] + ".pdb"  # Adjusts output file name based on input
